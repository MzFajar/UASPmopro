...
import com.restaurant.mzfajar.model.RegisterResponse;
import com.restaurant.mzfajar.utils.DialogUtils;

import static com.restaurant.mzfajar.data.Constans.REGISTER;
                    ...
                    public void onResponse(Object response) {
                        if (response instanceof RegisterResponse) {
                            ...
                            if (res.getStatus().equals("success")) {
                                Toast.makeText(RegisterActivity.this, "Register Berhasil, silakan login kembali",
